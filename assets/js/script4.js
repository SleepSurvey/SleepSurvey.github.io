...
(function() {
  ...
  function displayScore() {
    ...
    if (numCorrect >7) {
      ...
      score.append('You scored ' + numCorrect + ' out of ' +
                   questions.length * 3 + '. Based on your answers, your drug and/or alcohol consumption habits are at a level that may negatively affect your sleeping habits. Here’s why you may be having trouble sleeping or reaping the benefits of sleep. Studies show that consuming alcohol, even a few days after studying, can negatively affect your ability to recall said content even if your exam is a few days after drinking. Drugs can have a wide variety of effects on your body and sleep habits. MDMA, a popular drug amongst young people and college students, is a psychoactive drug that causes greater release of serotonin, which is the precursor to melatonin. This release causes a great depletion of the neurotransmitter important for sleep regulation. Users also report sleep-paralysis and night terrors as a common side-effect after an MDMA binge.You should reconsider your alcohol/drug habits!');
      return score;
    }
  }
})();